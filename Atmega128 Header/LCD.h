#ifndef CUSTOM_LCD_PIN	// CUSTOM_LCD_PIN을 사용자가 직접 정의하지 않을 경우 default값 PORTC
#define DB PORTC
#endif

#ifndef CUSTOM_LCD_RSWC	// CUSTOM_LCD_RSWC를 사용자가 직접 정의하지 않을 경우 default값 PORTA
#define MODE_SELECT PORTA	// 0 ~ 2까지 순서대로 RS, RW, E
#endif

#ifndef CUSTOM_F_CPU	// CUSTOM_F_CPU를 사용자가 직접 정의하지 않을 경우 default값 16MHz
